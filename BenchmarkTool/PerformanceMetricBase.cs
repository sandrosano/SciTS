...
namespace BenchmarkTool
{
    public abstract class PerformanceMetricBase<T> : IMetric<T>
    {
        ...
        public abstract T ToLogRecord(string mode, int percentage, long timestamp,long iterationTimestamp, DateTime startDate,  int batchSize, int clientsNb, int sensorNb, int client, int iteration, int dimNb,  bool regularity);
    }
}